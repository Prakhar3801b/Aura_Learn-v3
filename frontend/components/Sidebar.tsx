    ...
    return (
        <nav className="sidebar-nav">
            ...
            <div className="sidebar-bottom">
                {/* Aura Assistant toggle */}
                <button
                    onClick={() => window.dispatchEvent(new CustomEvent('aura-toggle-chat'))}
                    className="sidebar-link"
                    style={{ color: 'var(--primary)', marginBottom: '0.25rem' }}
                ...
                >
                    ...
                    <span className="tooltip">Aura Assistant</span>
                </button>
                {/* Dark mode toggle */}
                <button
