...
AR_LABS: list[ARLab] = [
    ...
    ARLab(
        ...
        description="Watch a 3D animated cell go through all phases of mitosis: prophase, metaphase, anaphase, and telophase — projected on your desk.",
        difficulty="beginner",
        duration_minutes=12,
        thumbnail="/ar-labs/thumbnails/cell.svg",
        tags=["mitosis", "cell cycle", "chromosomes", "cell division", "biology"],
        scene=ARLabScene(
            component="mitosis-lab",
            entities=[
                {"type": "sphere", "id": "cell", "radius": 0.12, "color": "#D1FAE5", "opacity": 0.6},
                {"type": "sphere", "id": "nucleus", "radius": 0.06, "color": "#6EE7B7", "opacity": 0.8},
                {"type": "cylinder", "id": "chromosome1", "radius": 0.008, "height": 0.04, "color": "#7C3AED"},
                {"type": "cylinder", "id": "chromosome2", "radius": 0.008, "height": 0.04, "color": "#7C3AED", "position": "0.015 0 0"},
                {"type": "text", "id": "phase-label", "value": "Interphase", "color": "#06B6D4", "position": "0 0.18 0"},
            ],
            instructions=[
                "Place the virtual cell on your desk",
                "Tap the cell to start mitosis animation",
                "Tap again to pause at each phase",
                "Pinch to zoom into chromosome details",
            ],
            learning_outcomes=[
                "6 phases of mitosis: interphase → telophase",
                "Role of spindle fibers and centromeres",
                "Chromosome number maintained (diploid → 2 diploid)",
